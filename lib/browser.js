...
var Browser = Fn.inherits('Informer', 'Develry.Specter', function Browser(options) {
	...
	// The page queue is used for the Tab#.goto() method,
	// only 10 gotos at once are allowed (per browser instance)
	this.page_queue = Fn.createQueue({
		enabled : true,
		limit   : 10
	});
