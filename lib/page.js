...
Page.setMethod(function addPageListeners() {
	...
	this.instance.on('onInitialized', function() {
		log.info('Page', that, 'has initialized', that.start_url);
 ...
 * @param    {String}   uri
 */
Page.setMethod(function injectJs(uri, callback) {
 ...
 * @version  0.1.0
 */
Page.setMethod(function evaluate(code, args, callback) {
 ...
 * @version  0.1.0
 */
Page.setMethod(function _evaluateJs(fnc, args, callback) {
